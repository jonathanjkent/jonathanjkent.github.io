...
![](int_fig1.png){width="100%"}
<font size="4">Continuous urban fabric in Barcelona (left) and discontinuous urban fabric in Berlin (right).</font>
...
![](int_map4.png){width="100%"}
<font size="4">Urban fabric of Barcelona (left) and Berlin (right).</font>
