...
In the Premier League, 83.7% of the time the score margin is less than 2. In the NBA, 84% of the time the margin is less than 14. So, a 14+ point lead in the NBA is similar in frequency to a 2 goal lead. If we treat 14 point leads as equivalent then:
