...
baseline_Twitter <- munis %>% select(geometry, z_tweets)
names(baseline_Twitter)[1] <- "Coverage"
baseline_Population <- munis %>% select(geometry, z_pop)
names(baseline_Population)[1] <- "Coverage"
```
